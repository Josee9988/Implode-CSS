let chalk,exitCodes;_36f‍.x([["auditCode",()=>auditCode],["fixCode",()=>fixCode]]);_36f‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_36f‍.w("./Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);/**
 ...
 */
    ...
    for (let i = 0; i < htmlPhpFiles.length; i++) { // TODO: make this work
        _36f‍.g.console.log(getFilesAndStyles.getCssReferencedInHtml(htmlPhpFiles[i]));
    }
    // get the css:
}
