let inquirer;_8cb‍.x([["promptForMissingOptions",()=>promptForMissingOptions],["default",()=>_8cb‍.o]]);_8cb‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);/**
 ...
 */
    ...
    return {
        ...
        /* fix: !(!options.fix && !options.audit) || (options.fix && options.audit) ? options.fix : answers.action === 'fix',
        audit: !(!options.fix && !options.audit) || (options.fix && options.audit) ? options.audit : answers.action === 'audit',
        // eslint-disable-next-line no-dupe-keys
        fix: ((!options.fix && !options.audit) || (options.fix && options.audit)) && (answers.action === 'fix') ? true : !(options.fix && options.audit),
        audit: ((!options.fix && !options.audit) || (options.fix && options.audit)) && (answers.action === 'audit') ? true : !(options.fix && options.audit), */
...
_8cb‍.d(promptForMissingOptions);
