let chalk,exitCodes;_2f8‍.x([["auditCode",()=>auditCode],["fixCode",()=>fixCode]]);_2f8‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_2f8‍.w("./Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);/**
 ...
 */
    ...
    for (let i = 0; i < htmlPhpFiles.length; i++) { // TODO: make this work
        _2f8‍.g.console.log(getFilesAndStyles.getCssReferencedInHtml(htmlPhpFiles[i]));
    }
    // get the css:
}
