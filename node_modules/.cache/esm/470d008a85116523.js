let chalk,exitCodes,getArrayHtmlPhpPaths,findFilesInDir,getIdsReferencedInHtml,getClassesReferencedInHtml,getUnusedCss,testPathFile;_851‍.x([["auditCode",()=>auditCode],["fixCode",()=>fixCode]]);_851‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_851‍.w("./Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);_851‍.w("./controller/getFiles",[["getArrayHtmlPhpPaths",["getArrayHtmlPhpPaths"],function(v){getArrayHtmlPhpPaths=v}],["findFilesInDir",["findFilesInDir"],function(v){findFilesInDir=v}]]);_851‍.w("./controller/getCssReferenced",[["getIdsReferencedInHtml",["getIdsReferencedInHtml"],function(v){getIdsReferencedInHtml=v}],["getClassesReferencedInHtml",["getClassesReferencedInHtml"],function(v){getClassesReferencedInHtml=v}]]);_851‍.w("./controller/geCssUnused",[["default",["getUnusedCss"],function(v){getUnusedCss=v}]]);_851‍.w("./testPath",[["default",["testPathFile"],function(v){testPathFile=v}]]);/**
