let chalk;_c27‍.x([["showCodeAndExit",()=>showCodeAndExit],["default",()=>_c27‍.o]]);_c27‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);/**
 ...
 * @return {void}
 */
       function showCodeAndExit(code, extraInformation = 'Not given', errorTraces) {
    switch (code) {
        case 200: // exiting OK
        ...
        default: // unknown error 501
            _c27‍.g.console.error(chalk.bold.red('\nUnknown error.'));
