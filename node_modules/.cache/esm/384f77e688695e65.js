let chalk,version;_886‍.x([["showOptions",()=>showOptions],["showVersion",()=>showVersion],["showHelp",()=>showHelp]]);_886‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_886‍.w("../package.json",[["default",["version"],function(v){version=v}]]);/**
 ...
 */
    ...
    _886‍.g.console.log(chalk.bold.green(options.folderToImplode));
    process.stdout.write('Audit (not performing any action, just showing the unused classes): ');
    _886‍.g.console.log(chalk.bold.green(options.audit));
    process.stdout.write('Fix (removed unused CSS ids and classes): ');
    _886‍.g.console.log(chalk.bold.green(options.fix) + chalk.white('\n'));
}
 ...
 */
    ...
    _886‍.g.console.log(chalk.bold.gray(version.version));
