let chalk,http,url,fs,path;_8dc‍.x([["runHttpServer",()=>runHttpServer],["writeDataFile",()=>writeDataFile],["default",()=>_8dc‍.o]]);_8dc‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_8dc‍.w("http",[["default",["http"],function(v){http=v}]]);_8dc‍.w("url",[["default",["url"],function(v){url=v}]]);_8dc‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_8dc‍.w("path",[["default",["path"],function(v){path=v}]]);/**
 ...
 */
       function runHttpServer(port = 4949) {
    const mimeType = {
        '.ico': 'image/x-icon',
        '.html': 'text/html',
        '.js': 'text/javascript',
 ...
 */
       function writeDataFile(unusedStyles) {
