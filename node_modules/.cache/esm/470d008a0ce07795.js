let chalk,exitCodes,getArrayHtmlPhpPaths,findFilesInDir,getIdsReferencedInHtml,getClassesReferencedInHtml,getUnusedCss,testPathFile,runHttpServer,writeDataFile,removeUnused;_0ce‍.x([["auditCode",()=>auditCode],["fixCode",()=>fixCode]]);_0ce‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_0ce‍.w("./Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);_0ce‍.w("./controller/getFiles",[["getArrayHtmlPhpPaths",["getArrayHtmlPhpPaths"],function(v){getArrayHtmlPhpPaths=v}],["findFilesInDir",["findFilesInDir"],function(v){findFilesInDir=v}]]);_0ce‍.w("./controller/getCssReferenced",[["getIdsReferencedInHtml",["getIdsReferencedInHtml"],function(v){getIdsReferencedInHtml=v}],["getClassesReferencedInHtml",["getClassesReferencedInHtml"],function(v){getClassesReferencedInHtml=v}]]);_0ce‍.w("./controller/geCssUnused",[["default",["getUnusedCss"],function(v){getUnusedCss=v}]]);_0ce‍.w("./controller/testPath",[["default",["testPathFile"],function(v){testPathFile=v}]]);_0ce‍.w("./server/createServer",[["runHttpServer",["runHttpServer"],function(v){runHttpServer=v}],["writeDataFile",["writeDataFile"],function(v){writeDataFile=v}]]);_0ce‍.w("./controller/fixCode",[["default",["removeUnused"],function(v){removeUnused=v}]]);/**
