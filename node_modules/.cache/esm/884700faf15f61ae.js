let chalk,version;_f15‍.x([["showOptions",()=>showOptions],["showVersion",()=>showVersion],["showHelp",()=>showHelp]]);_f15‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_f15‍.w("../../package.json",[["default",["version"],function(v){version=v}]]);/**
 ...
 */
    ...
    _f15‍.g.console.log(chalk.bold.green(options.folderToImplode));
    process.stdout.write(`    ${chalk.red('Audit')} Not performing any action, just showing the unused classes: `);
    _f15‍.g.console.log(chalk.bold.green(options.audit));
    process.stdout.write(`    ${chalk.red('Fix')}   Remove unused CSS ids and classes: `);
    _f15‍.g.console.log(chalk.bold.green(options.fix) + chalk.white('\n'));
}
 ...
 */
    ...
    _f15‍.g.console.log(chalk.bold.gray(version.version));
