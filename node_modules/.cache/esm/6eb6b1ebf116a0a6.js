let arg,confirm,exitCodes,promptForMissingOptions,testPath,auditCode,fixCode,showOptions,showHelp,showVersion;_f11‍.x([["cli",()=>cli]]);_f11‍.w("arg",[["default",["arg"],function(v){arg=v}]]);_f11‍.w("@inquirer/confirm",[["default",["confirm"],function(v){confirm=v}]]);_f11‍.w("../Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);_f11‍.w("./promptCLI",[["default",["promptForMissingOptions"],function(v){promptForMissingOptions=v}]]);_f11‍.w("../testPath",[["default",["testPath"],function(v){testPath=v}]]);_f11‍.w("../main",[["auditCode",["auditCode"],function(v){auditCode=v}],["fixCode",["fixCode"],function(v){fixCode=v}]]);_f11‍.w("./informationCLI",[["showOptions",["showOptions"],function(v){showOptions=v}],["showHelp",["showHelp"],function(v){showHelp=v}],["showVersion",["showVersion"],function(v){showVersion=v}]]);/**
