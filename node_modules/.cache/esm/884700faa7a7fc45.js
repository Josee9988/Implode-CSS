let chalk,version;_a7a‍.x([["showOptions",()=>showOptions],["showVersion",()=>showVersion],["showHelp",()=>showHelp]]);_a7a‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_a7a‍.w("../../package.json",[["default",["version"],function(v){version=v}]]);/**
 ...
 */
    ...
    _a7a‍.g.console.log(chalk.bold.green(options.folderToImplode));
    process.stdout.write(`    ${chalk.red('Audit')} Not performing any action, just showing the unused classes: `);
    _a7a‍.g.console.log(chalk.bold.green(options.audit));
    process.stdout.write(`    ${chalk.red('Fix')}   Remove unused CSS ids and classes: `);
    _a7a‍.g.console.log(chalk.bold.green(options.fix) + chalk.white('\n'));
}
 ...
 */
    ...
    _a7a‍.g.console.log(chalk.bold.gray(version.version));
