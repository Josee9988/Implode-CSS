let chalk,exitCodes,getArrayHtmlPhpPaths,findFilesInDir,getIdsReferencedInHtml,getClassesReferencedInHtml,getUnusedCss,testPathFile,runHttpServer,writeDataFile,removeUnused;_f39‍.x([["auditCode",()=>auditCode],["fixCode",()=>fixCode]]);_f39‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_f39‍.w("./Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);_f39‍.w("./controller/getFiles",[["getArrayHtmlPhpPaths",["getArrayHtmlPhpPaths"],function(v){getArrayHtmlPhpPaths=v}],["findFilesInDir",["findFilesInDir"],function(v){findFilesInDir=v}]]);_f39‍.w("./controller/getCssReferenced",[["getIdsReferencedInHtml",["getIdsReferencedInHtml"],function(v){getIdsReferencedInHtml=v}],["getClassesReferencedInHtml",["getClassesReferencedInHtml"],function(v){getClassesReferencedInHtml=v}]]);_f39‍.w("./controller/geCssUnused",[["default",["getUnusedCss"],function(v){getUnusedCss=v}]]);_f39‍.w("./controller/testPath",[["default",["testPathFile"],function(v){testPathFile=v}]]);_f39‍.w("./server/createServer",[["runHttpServer",["runHttpServer"],function(v){runHttpServer=v}],["writeDataFile",["writeDataFile"],function(v){writeDataFile=v}]]);_f39‍.w("./controller/fixCode",[["default",["removeUnused"],function(v){removeUnused=v}]]);/**
