let fs,path,exitCodes;_f32‍.x([["getArrayHtmlPhpPaths",()=>getArrayHtmlPhpPaths],["findFilesInDir",()=>findFilesInDir],["getCssReferencedInHtml",()=>getCssReferencedInHtml],["getIdsAndClassesFromString",()=>getIdsAndClassesFromString]]);_f32‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_f32‍.w("path",[["default",["path"],function(v){path=v}]]);_f32‍.w("./exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);/**
 ...
 */
    ...
    _f32‍.g.console.log(/(id="(.*?)(\"))/g.exec(lineWithCss)[2]);
}
