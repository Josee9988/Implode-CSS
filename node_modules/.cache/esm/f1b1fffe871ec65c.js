let fs,chalk,path,exitCodes;_871‍.x([["getArrayHtmlPhpPaths",()=>getArrayHtmlPhpPaths],["findFilesInDir",()=>findFilesInDir],["getCssReferencedInHtml",()=>getCssReferencedInHtml],["getIdsAndClassesFromString",()=>getIdsAndClassesFromString]]);_871‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_871‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_871‍.w("path",[["default",["path"],function(v){path=v}]]);_871‍.w("./exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);/**
 ...
 */
    ...
    _871‍.g.console.log(/(id="(.*?)(\"))/g.exec(lineWithCss)[2]);
}
