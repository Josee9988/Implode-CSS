let arg,confirm,exitCodes,promptForMissingOptions,testPath,auditCode,fixCode,showOptions,showHelp,showVersion;_bf8‍.x([["cli",()=>cli]]);_bf8‍.w("arg",[["default",["arg"],function(v){arg=v}]]);_bf8‍.w("@inquirer/confirm",[["default",["confirm"],function(v){confirm=v}]]);_bf8‍.w("../Exceptions/exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);_bf8‍.w("./promptCLI",[["default",["promptForMissingOptions"],function(v){promptForMissingOptions=v}]]);_bf8‍.w("../testPath",[["default",["testPath"],function(v){testPath=v}]]);_bf8‍.w("../main",[["auditCode",["auditCode"],function(v){auditCode=v}],["fixCode",["fixCode"],function(v){fixCode=v}]]);_bf8‍.w("./informationCLI",[["showOptions",["showOptions"],function(v){showOptions=v}],["showHelp",["showHelp"],function(v){showHelp=v}],["showVersion",["showVersion"],function(v){showVersion=v}]]);/**
