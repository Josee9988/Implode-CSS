let chalk,version;_ca5‍.x([["showOptions",()=>showOptions],["showVersion",()=>showVersion],["showHelp",()=>showHelp]]);_ca5‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);_ca5‍.w("../../package.json",[["default",["version"],function(v){version=v}]]);/**
 ...
 */
    ...
    _ca5‍.g.console.log(chalk.bold.gray(version.version));
 ...
 */
    ...
    console.log('  -i, --ignoreFolders\t  Ignore folders (add multiple folder name by separating them with commas)');

    _ca5‍.g.console.log(chalk.bold('\nExamples of use:'));
