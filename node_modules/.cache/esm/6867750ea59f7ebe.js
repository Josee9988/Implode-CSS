let inquirer;_a59‍.x([["promptForMissingOptions",()=>promptForMissingOptions],["default",()=>_a59‍.o]]);_a59‍.w("inquirer",[["default",["inquirer"],function(v){inquirer=v}]]);/**
 ...
 */
    ...
    return {
        ...
        port: options.port >= 1000 && options.port <= 65535 ? options.port : 4949,
    };
}

_a59‍.d(promptForMissingOptions);
