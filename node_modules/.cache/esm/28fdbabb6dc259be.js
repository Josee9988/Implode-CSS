let fs;_6dc‍.x([["getCreated",()=>getCreated],["default",()=>_6dc‍.o]]);_6dc‍.w("fs",[["default",["fs"],function(v){fs=v}]]);

       async function getCreated(cssFiles, idsFoundHTML, classFoundHTML) {
    let idsInCss = [];
    let classInCss = [];
    ...
    _6dc‍.g.console.log(idsNotUsed);
    _6dc‍.g.console.log(classNotUsed);
}
