let arg,confirm,exitCodes,promptForMissingOptions,testPath,auditCode,fixCode,showOptions,showHelp,showVersion;_fbe‍.x([["cli",()=>cli]]);_fbe‍.w("arg",[["default",["arg"],function(v){arg=v}]]);_fbe‍.w("@inquirer/confirm",[["default",["confirm"],function(v){confirm=v}]]);_fbe‍.w("./exitCodes",[["default",["exitCodes"],function(v){exitCodes=v}]]);_fbe‍.w("./promptCLI",[["default",["promptForMissingOptions"],function(v){promptForMissingOptions=v}]]);_fbe‍.w("./testPath",[["default",["testPath"],function(v){testPath=v}]]);_fbe‍.w("./main",[["auditCode",["auditCode"],function(v){auditCode=v}],["fixCode",["fixCode"],function(v){fixCode=v}]]);_fbe‍.w("./informationCLI",[["showOptions",["showOptions"],function(v){showOptions=v}],["showHelp",["showHelp"],function(v){showHelp=v}],["showVersion",["showVersion"],function(v){showVersion=v}]]);/**
